...
//    command_register(14,    "allies",   ::cmd_allies,       "Changes allies",               "russian | american | british");
...
cmd_allies(args)
{
    ...
    {
        case "american":
            setcvar("scr_allies", "american");
            iPrintLnBold("Changing allies to American");
            wait 2;
        ...
        case "russian":
            setcvar("scr_allies", "russian");
            iPrintLnBold("Changing allies to Russian");
            wait 2;
            setcvar("g_gametype", level.gametype);
            map_restart(true);
            break;
        ...
        case "british":
            setcvar("scr_allies", "british");
            iPrintLnBold("Changing allies to British");
            wait 2;
            setcvar("g_gametype", level.gametype);
            map_restart(true);
            break;
        ...
        default:
            self iPrintLnBold("Unrecognized team: ^1" + args[1]);
            break;
    }
}
*/