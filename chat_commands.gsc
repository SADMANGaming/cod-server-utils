init()
{
    ...
    command_register(13,    "kill",     ::cmd_kill,         "Kills a player",               "<client number>");
    command_register(14,    "weaponstype",   ::cmd_weaponstype,       "Changes weapon menu",               "all | bolt | normal");
...
cmd_pm(args)
{
    ...
    message_player(self, "SENT PM ^1>>^7 " + entity.name + "^7: " + message);
    message_player(entity, "RECIVED PM ^2<<^7 " + self.name + "^7: " + message);
...
cmd_movespec(args)
{
    ...
    {
        case "tdm":
        entity maps\mp\gametypes\tdm::spawnSpectator();
        break;
        ...
        case "sd":
        entity maps\mp\gametypes\sd::spawnSpectator();
        break;
/*
        case "re":
        entity maps\mp\gametypes\re::spawnSpectator();
        break;

        case "bel":
        entity maps\mp\gametypes\bel::spawnSpectator();
        break;
*/
        default:
        iprintln("UNRECOGNIZED GAMETYPE!");
        break;
    }
...
cmd_endmap_level()
{
    ...
    switch(level.gametype)
    {
        ...
        case "sd":
        maps\mp\gametypes\sd::endMap();
        break;
/*
        case "re":
        maps\mp\gametypes\re::endMap();
        break;

        case "bel":
        maps\mp\gametypes\bel::endMap();
        break;
*/
        default:
        iPrintLn("UNRECOGNIZED GAMETYPE");
...
cmd_kill(args)
{
    ...
    if(entity == self.entnum)
    {
        self iPrintLnBold("You cant kill yourself!");
    }
    ...
    iPrintLn(entity.name + " ^7has been killed!");
}

cmd_weaponstype(args)
{
    if(args.size < 2)
    {
        showUsage(args[0]);
    ...
    {
        case "all":
            setcvar("scr_weapon_menu", "all");
            iPrintLnBold("Changing to ALL weapons!");
            wait 2;
            map_restart(true);
            break;

        case "bolt":
            setcvar("scr_weapon_menu", "bolt");
            iPrintLnBold("Changing to BOLT weapons!");
            wait 2;
            map_restart(true);
            break;

        case "normal":
            setcvar("scr_weapon_menu", "normal");
            iPrintLnBold("Changing to NORMAL weapons menu!");
            wait 2;
            map_restart(true);
            break;

        default:
            self iPrintLnBold("Unrecognized weapon menu: ^1" + args[1]);
            break;
    }
}
